...
const GEAR: Array<{ label: string; img?: string }> = [
  ...
  { label: "Gloves", img: "/gloves.png" }, // place gloves.png in /public 
  { label: "Shoes", img: "/shoes.png" }, // place shoes.png in /public
  { label: "Suit", img: "/suit.png" }, // place suit.png in /public
];
      ...
      <div className="rounded-xl bg-[var(--gf-navy)] p-6 md:p-8 space-y-10">
        ...
        <section className="space-y-4">
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-1">
              <li>
                US: {ext("https://www.worldkarting.com/", "WKA")},{" "}
